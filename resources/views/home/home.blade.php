...
<body>
<form action="/api/adauth/login" method="post">
    mobile : <input type="text" name="user_name" value="blue1">
    password : <input type="text" name="password" value="123456">
    <input type="submit" value="submit">
</form>

<br>注册: <br>
<form action="/api/adauth/register" method="post">
    name : <input type="text" name="user_name" id="name" value="blue">
    password : <input type="text" name="password" value="123456">
