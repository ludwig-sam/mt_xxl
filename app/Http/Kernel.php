...
//        \Illuminate\Foundation\Http\Middleware\ConvertEmptyStringsToNull::class,
    ...
    protected $routeMiddleware = [
        ...
        'cross_http'  => CrossHttp::class,
        'pay'         => Pay::class,
        'want_json'   => WantJson::class,
        'verify_access_token' => AccessTokenMiddleware::class,
        'log_request'   => LogRequestMiddleware::class,
        'wateway_risk' => GatewayMiddleware::class,
